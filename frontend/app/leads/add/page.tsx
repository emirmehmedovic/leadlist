        ...
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className="mb-8 slide-up">
            ...
            <div className="flex items-center space-x-4 mb-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gradient">Novi klijent</h1>
                <p className="text-neutral-600 mt-1">Unesite informacije o potencijalnom klijentu</p>
              </div>
            </div>
          </div>
